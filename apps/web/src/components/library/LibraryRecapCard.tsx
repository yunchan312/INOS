...
export function LibraryRecapCard({ stats }: { stats: RecapStats }) {
  return (
    <div className="mx-auto w-full max-w-[420px] border border-line rounded-card bg-surface">
      {/* 노랑 헤더 */}
      ...
      <div className="grid grid-cols-3 divide-x divide-line border-b border-line text-center">
        <div className="px-2 py-5">
          <p className="text-[28px] font-bold leading-none">{stats.bookCount}</p>
          <p className="mt-1.5 text-[11px] font-semibold uppercase tracking-[0.12em] text-muted">책</p>
        </div>
        <div className="px-2 py-5">
          <p className="text-[28px] font-bold leading-none">{stats.movieCount}</p>
        ...
        <div className="border-b border-line px-6 py-5">
          ...
          <div className="mt-2 flex items-start justify-between gap-3">
            <div className="min-w-0">
              <p className="truncate text-[18px] font-bold">{stats.topPick.title}</p>
